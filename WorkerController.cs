...
namespace Portal.Controllers
{
    public class WorkerController : Controller
    {
        ...
        // GET: WorkerController/Salary/5
        public ActionResult Salary(int id)
        {
            List<SalaryLog> objs = workerClass.GetSalaryLogByWorkerID(id).ToList();
            if (objs == null)
            {
                return HttpNotFound();
            }
        ...
        // GET: WorkerController/Holiday/5
        public ActionResult Holiday(int id)
        {

            Holiday objs = new Holiday();
            objs.holidays =  workerClass.GetHolidayByWorkerID(id);
            return View(objs);

        }

        // POST: WorkerController/Holiday/5
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Holiday([Bind] Holiday obj)
        {
            try
            {
                if (ModelState.IsValid)
